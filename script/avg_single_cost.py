...
def process_csv(file_path):
    ...
    # 定义分组列和需要计算平均值的列
    # group_columns = ['compactor', 'thread', 'ops per thread', 'case', 'stage']
    group_columns = ['compactor',  'case', 'stage']
    # 自动识别非分组列作为需要计算平均值的列
...
#用以处理单个文件的平均
#用法：python3 /home/kvgroup/louzy/LaCoLSM/script/avg_single_cost.py <文件路径>
