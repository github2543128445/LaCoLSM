...
// #else
// static const int kL0_CompactionTrigger = 1;//default
// #endif
...
static const double max_mega_bytes_for_level_base = 256.0;  //level 1是256MB ,每一层×10
...
static const int kMaxMemCompactLevel = 2; //LZY:trival move最多到2？
